...
-- prive of 44.00, and can_be_returned of false.
...
-- Display only the products that have a price in between $$22.50 and 99.00
...
-- And now the sale is over. For the remaining products, increase their price by $30/.
UPDATE products SET price = price + 20;
